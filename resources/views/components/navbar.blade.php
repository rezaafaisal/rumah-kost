        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="/register" method="POST" class="p-4">
                    ...
                    <div class="form-outline mt-4">
                        <input type="password" name="password" id="form43" class="form-control form-control-lg" required/>
                        {{-- <i class="fas fa-eye"></i> --}}
                        <label class="form-label" for="form43">Password</label>
                    </div>
                    <div class="form-outline mt-4">
                        <input type="password" id="form43" class="form-control form-control-lg" required/>
